...
namespace UploadImageCategoria
{
    public static class UploadImageCategoria
    {
        [FunctionName("UploadImageCategoria")]
            ...
            ILogger log)
        {
            try
            {
                ...
                using (var memorystream = new MemoryStream())
                {
                    ...
                    var contenedorRef = cliente.GetContainerReference("categorias");
